...
class BudgetMetadata:
    ...
    cover_sheet_data: Dict[str, Any] = field(default_factory=dict)  # Added cover sheet data
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'cover_sheet_data': self.cover_sheet_data  # Added cover sheet data
        }
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'BudgetMetadata':
        ...
        return cls(
            ...
            cover_sheet_data=data.get('cover_sheet_data', {})  # Added cover sheet data
        ) 